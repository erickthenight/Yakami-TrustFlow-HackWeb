# ⚠️ ATENÇÃO BANCA AVALIADORA: LINK OFICIAL DE SUBMISSÃO ⚠️
...
👉 **[CLIQUE AQUI PARA ACESSAR O REPOSITÓRIO OFICIAL (FORK) DO PROJETO YAKAMI](https://github.com/YakamiTech/erickthenight-trustcode-template)** 👈
...
* **Verificar o Smart Contract:** Acesse as transações diretamente na rede Sepolia (link nos Requisitos Mínimos).
* **Testar o Dashboard Web:** Acesso ao Sandbox Mendix.
* **Página Oficial do Hackathon:** [www.yakami.com.br/hackweb.html](http://www.yakami.com.br/hackweb.html)
...
* **Apresentação e Documentação:** Disponíveis integralmente na Landing Page Executiva do Projeto e nas pastas `/assets` e `/docs` deste repositório.
